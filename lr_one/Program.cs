...
namespace LR_One
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" Дата рождения студента: 08.09.2006");
            Console.WriteLine("Выполнил: Николенко Натали Константиновна");
            Console.WriteLine("Группа: ИДПО-ИСИТ-3-24/1");
